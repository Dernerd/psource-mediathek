...
// Generated by the PsourceMediathek Debug tool //
...
GD enabled:              <?php echo psmt_get_yes_no_from_boolean( $gd_enabled ) . "\n"; ?>
<?php if( $gd_enabled ):?>
...
// PsourceMediathek Settings //

<?php $settings = psmt_get_all_options();

foreach( $settings as $key => $value ) {
	echo $key . ':		' . psmt_array_to_string($value) ."\n";
	
}

?>

// End of PsourceMediathek Settings //

<?php 
if ( has_action( 'psmt_admin_debug_extra' ) ) {
	echo "\n";
	do_action( 'psmt_admin_debug_extra' );
}

function psmt_get_yes_no_from_boolean( $what ) {
