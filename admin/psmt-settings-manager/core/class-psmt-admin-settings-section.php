 ...
 * Settings Section.
 */
class PSMT_Admin_Settings_Section {
	/**
	 ...
	 *
	 * @return PSMT_Admin_Settings_Section
	 */
	public function add_field( $field ) {

		// check if a field class with name PSMT_Admin_Settings_Field_$type exists, use it.
		$type = 'text';
		...
		$class_name = 'PSMT_Admin_Settings_Field';
		// a field specific class can be declared as PSMT_Admin_Settings_Field_typeName.
	 ...
	 *
	 * @see PSMT_Admin_Settings_Section::add_field()
	 *
	 ...
	 *
	 * @return PSMT_Admin_Settings_Field[]
	 */
