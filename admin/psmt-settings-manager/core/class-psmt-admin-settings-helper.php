 ...
 */
class PSMT_Admin_Settings_Upload_Helper {
	 ...
	 * Singleton instance.
	 *
	 * @var PSMT_Admin_Settings_Upload_Helper
	 */
	...
	/**
	 * PSMT_Admin_Settings_Upload_Helper constructor.
	 */
	 ...
	 *
	 * @return PSMT_Admin_Settings_Upload_Helper
	 */
	...
	public function add_page( $page_name, $page = null ) {
		...
		if ( ! $page ) {
			$page = new PSMT_Admin_Settings_Page( $page_name );
		}
	...
	public function load_js() {
		...
		wp_enqueue_media();
		wp_enqueue_script( 'psmt-admin-options-media-uploader', $this->url . '_inc/uploader.js', array( 'jquery' ) );

	}
}

// PSMT_Admin_Settings_Upload_Helper::get_instance();
