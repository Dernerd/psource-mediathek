 ...
 *
 */
class PSMT_Admin_Settings_Field_Extensions extends PSMT_Admin_Settings_Field {
	/**
	 * Field key(type key).
	 *
	 * @var string
	...
	/**
	 * PSMT_Admin_Settings_Field_Extensions constructor.
	 *
	...
	public function get_value( $options ) {
		...
		$type = psmt_get_type_object( $this->key );
