 ...
 * @return boolean
 */
function psmt_admin_is_gallery_list() {

	$screen_id = 'edit-' . psmt_get_gallery_post_type();
 ...
 */
function psmt_taxonomy_filter_clauses( $clauses, $wp_query ) {

	// only apply if we are on the psmt gallery list screen.
	...
	$order_by_tax = psmt_translate_to_taxonomy( $order_by );
...
add_filter( 'posts_clauses', 'psmt_taxonomy_filter_clauses', 10, 2 );
