 ...
 */
function psmt_add_gallery_meta( $gallery_id, $meta_key, $meta_value, $unique = false ) {
 ...
 */
function psmt_get_gallery_meta( $gallery_id, $meta_key = '', $single = false ) {
 ...
 *                  false on failure.
 */
function psmt_update_gallery_meta( $gallery_id, $meta_key, $meta_value, $prev_value = '' ) {
 ...
 */
function psmt_delete_gallery_meta( $gallery_id, $meta_key = '', $meta_value = '' ) {
