...
/**
 * Helps in excluding PsourceMediathek comments  from the normal UI/Flow of WordPress comments
 * 
 */
class PSMT_Comments_Exclusion_Helper {
	...
	private function __construct() {
		...
		$this->comment_type = psmt_get_comment_type();
	...
	/**
	 * 
	 * @return PSMT_Comments_Exclusion_Helper
	 */
...
PSMT_Comments_Exclusion_Helper::get_instance();
