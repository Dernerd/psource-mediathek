 ...
 */
class PSMT_Remote_Media_Parser {
	...
	/**
	 * PSMT_Remote_Media_Importer constructor.
	 *
	...
	private function parse_raw( $args = array() ) {
		...
		$this->extension = psmt_get_file_extension( $this->url );
		$this->type      = psmt_get_media_type_from_extension( $this->extension );
