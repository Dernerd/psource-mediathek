 ...
 * @return false|int
 */
function psmt_add_media_meta( $media_id, $meta_key, $meta_value, $unique = false ) {
 ...
 * @return mixed
 */
function psmt_get_media_meta( $media_id, $meta_key = '', $single = false ) {
 ...
 * @return bool|int
 */
function psmt_update_media_meta( $media_id, $meta_key, $meta_value, $prev_value = '' ) {
 ...
 * @return bool
 */
function psmt_delete_media_meta( $media_id, $meta_key = '', $meta_value = '' ) {
