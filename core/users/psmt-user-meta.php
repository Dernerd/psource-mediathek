 ...
 */
function psmt_get_user_meta( $user_id, $meta_key, $single = false ) {
 ...
 */
function psmt_update_user_meta( $user_id, $meta_key, $meta_value = '' ) {
 ...
 */
function psmt_delete_user_meta( $user_id, $meta_key, $meta_value = '' ) {
