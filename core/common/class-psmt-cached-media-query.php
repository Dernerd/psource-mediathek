...
/**
 * PsourceMediathek Cached Media query class
 *
 ...
 * @since 1.0.0
 */
class PSMT_Cached_Media_Query extends WP_Query {

	/**
	 * PSMT_Cached_Media_Query constructor.
	 *
	...
	public function query( $args ) {
		...
		if ( isset( $args['in'] ) ) {
			...
			$args['post_type'] = psmt_get_media_post_type();
