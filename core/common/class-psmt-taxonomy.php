...
class PSMT_Taxonomy {
	...
	public function __construct( $args, $taxonomy ) {
		...
		if ( isset( $args['key'] ) ) {
			$term = _psmt_get_term( $args['key'], $taxonomy );
		} elseif ( isset( $args['id'] ) ) {
			$term = _psmt_get_term( $args['id'], $taxonomy );
		}
 ...
 */
class PSMT_Status extends PSMT_Taxonomy {

	/**
	 * PSMT_Status constructor.
	 *
	 * @param array $args array of args.
	 */
	public function __construct( $args ) {
		parent::__construct( $args, psmt_get_status_taxname() );
	}
}
 ...
 */
class PSMT_Type extends PSMT_Taxonomy {
	/**
	 ...
	 *  as selected in the PsourceMediathek settings.
	 *
	...
	/**
	 * PSMT_Type constructor.
	 *
	 * @param array $args array of args.
	 */
	public function __construct( $args ) {

		parent::__construct( $args, psmt_get_type_taxname() );

		$this->registered_extensions = $args['extensions'];

		$this->extensions = psmt_get_media_extensions( $this->get_slug() );
	}

	/**
	 * An array of allowed extensions( as updated by site admin in the PsourceMediathek settings )
	 *
	...
	/**
	 * An array of registered extensions( as registered by developer while using psmt_register_type)
	 *
 ...
 */
class PSMT_Component extends PSMT_Taxonomy {
	/**
	...
	/**
	 * PSMT_Component constructor.
	 *
	 * @param array $args array of args.
	 */
	public function __construct( $args ) {

		parent::__construct( $args, psmt_get_component_taxname() );

		$this->features = new PSMT_Features();
	}
