 ...
 *
 * Do not use this class directly, see psourcemediathek/core/logger/functions.php for the API
 */
class PSMT_DB_Logger extends PSMT_Logger {
	/**
	 * Singleton instance.
	 *
	 * @var self
	...
	private function __construct() {
		$this->table = psourcemediathek()->get_table_name( 'logs' );
	}

	/**
	 * Get singleton instance
	 *
	 * @return PSMT_DB_Logger
	 */
