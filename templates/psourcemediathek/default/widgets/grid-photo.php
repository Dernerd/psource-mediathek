...
<?php if ( $query->have_media() ) : ?>
	...
	<div class="psmt-container psmt-widget-container psmt-media-widget-container psmt-media-photo-widget-container">

		<div class='psmt-g psmt-item-list psmt-media-list psmt-photo-list'>

			<?php while ( $query->have_media() ) : $query->the_media(); ?>
				<?php $type = psmt_get_media_type(); ?>
				<div class="<?php psmt_media_class( 'psmt-widget-item psmt-widget-photo-item ' . psmt_get_grid_column_class( 1 ) ); ?>" data-psmt-type="<?php echo $type;?>">
