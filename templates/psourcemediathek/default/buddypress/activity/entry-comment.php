...
if ( $psmtq->have_media() ) : ?>
	<div class="psmt-container psmt-media-list psmt-activity-comment-media-list">
		...
		<?php while ( $psmtq->have_media() ) : $psmtq->the_media(); ?>
            ...
            <?php if ( psmt_user_can_view_media( psmt_get_media_id() ) ) : ?>
                <div class="<?php psmt_media_class( 'psmt-activity-comment-media-entry psmt-activity-comment-media-entry-audio' ); ?>" id="psmt-activity-comment-media-entry-<?php psmt_media_id(); ?>" data-psmt-type="<?php echo $type;?>">
                    ...
                    <a href="<?php psmt_media_permalink(); ?>" title="<?php echo esc_attr( psmt_get_media_title() ); ?>" data-psmt-type="<?php echo $type;?>" data-psmt-activity-id="<?php echo $activity_id; ?>" data-psmt-media-id="<?php psmt_media_id(); ?>" class="psmt-media psmt-activity-comment-media psmt-activity-comment-<?php psmt_media_type();?>">
