	...
	<div class="psmt-lightbox-uploader-upload-details">
		...
		<div class="psmt-lightbox-action-links">
			...
			<?php if ( psmt_user_can_edit_media( psmt_get_media_id() ) ) : ?>
                <a class="psmt-lightbox-media-action-link psmt-lightbox-edit-media-link" href="#" data-psmt-media-id="<?php psmt_media_id();?>"><?php _ex('Bearbeiten', 'lightbox edit media edit action label', 'psourcemediathek' );?> </a>
                <a class="psmt-lightbox-media-action-link psmt-lightbox-edit-media-cancel-link" href="#" data-psmt-media-id="<?php psmt_media_id();?>"><?php _ex('Abbrechen', 'lightbox edit media cancel action label', 'psourcemediathek' );?></a>
			<?php endif;?>
